...
function setup() {
 ...
 canvas.parent('canvas-pa');
  ...
  startBtn.position(windowWidth * 0.61, windowHeight * 0.0774);
  startBtn.style('fontSize', '30px')
  startBtn.style('font-family', 'Times New Roman')
  startBtn.style('background-color', '#ffff');
 startBtn.style('padding', '8px 8px');
 startBtn.style('background-color', '#ffff');
 startBtn.style('border', 'none');
 startBtn.style('border-radius', '2px');
...
linkImage.position(windowWidth * 0.775, windowHeight * 0.0774);  
linkImage.mousePressed(() => {
  window.open('game.html'); 
});
linkImage.style('windowHeight * 0.035');
linkImage.style('fontSize', '29px')
linkImage.style('padding', '8px 8px');
...
linkImage.style('font-family', 'Times New Roman')
...
function draw() {
  ...
  text("Score: " + score, windowWidth * 0.04, windowHeight * 0.11);
